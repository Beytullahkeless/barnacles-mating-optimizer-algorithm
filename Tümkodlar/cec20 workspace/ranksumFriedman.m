...
filename = 'all100.xlsx';
fileread = 'result-d=100.xlsx';
run = 25;
...
for i = 1 : algorithmsNumber
    solutionR(i,:,:) = xlsread(fileread, char(algorithms(i)));
