...
function[bestSolution, bestFitness, iteration] = BMO_RFDB_Case_10(fhd, dimension, maxFEs, fNumber);
ayarlar;
...
for i=1:size(BarnaclesPositions,1)
    if flag == 1
        ...
        BarnaclesFitness(1,i)= testFunction(BarnaclesPositions(i,:)', fhd, fNumber);%fobj(BarnaclesPositions(i,:));
    end
    FE=FE +1;
...
while FE<maxFEs
    ...
    %Start Barnacles Algorithm
     ...
     k2 = randperm(N);
     for i=1:size(BarnaclesPositions,1)
     B_Fitness(1,i)= testFunction(BarnaclesPositions(i,:)', fhd, fNumber);
     %FE = FE +1;
     end
     index_fdb = rouletteFitnessDistanceBalance(BarnaclesPositions, B_Fitness);
     k3 = ones(1, N) * index_fdb;
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:size(Barnaclescolony,1)
        ...
        if flag == 1
            ...
            BarnaclesFitness(1,i)= testFunction(Barnaclescolony(i,:)', fhd, fNumber);%fobj(Barnaclescolony(i,:));
        end
